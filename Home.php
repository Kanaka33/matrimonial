...
class Home extends CI_Controller {
    ...
    function ajax_member_list($para1="",$para2="")
    {
        ...
        elseif ($para2 == "search") {
           ...
           $aged_from = $this->input->post('aged_from');
			...
			if (isset($first_name) && $first_name != "") {
                $array_data = array('first_name' => $first_name);
                $array_data = status($member_approval, $array_data);
            ...
            $all_array = array_intersect($by_gender,$by_member_profile_id,$by_first_name,$by_property,$by_marital_status,$by_profession,$by_religion,$by_caste,$by_sub_caste,$by_language,$by_country,$by_state,$by_city,$by_age,$by_height);
        ...
        elseif ($para2 == "search") {
            ...
            $all_array = array_intersect($by_gender,$by_member_profile_id,$by_first_name,$by_property,$by_profession,$by_marital_status,$by_religion,$by_caste,$by_sub_caste,$by_language,$by_country,$by_state,$by_city,$by_age,$by_height);
        ...
        elseif ($para1=="update_all") {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $family_info[] = array('father'             =>  $this->input->post('father'),
									...
									'name_sister'        	=>  $this->input->post('name_sister'),
									'no_brother'        	=>  $this->input->post('no_brother'),
									'name_brother'       	=>  $this->input->post('name_brother')
                                    );
