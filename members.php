...
if(empty($this->session->userdata['member_id'])){?>
	<div class='text-center pt-5 pb-5'><i class='fa fa-exclamation-triangle fa-5x'></i><h5><?=translate('register_now!')?></h5></div>	
<?php } else {
            ...
            <div class="row align-items-center">
                <div class="col-sm-12 text-center">
                    <ul class="inline-links inline-links--style-3">
                        ...
                        <?php if($this->db->get_where("member", array("member_id" => $member->member_id))->row()->is_closed == "yes"){ echo " "; }else{?>
                            <li class="listing-hover">
                                <?php
