    ...
    <div class="profile">
        <div class="container">
            <?php foreach ($get_member as $member): ?>
                                        ...
                                        <div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
                                            <div id="edit_astronomic_information">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group has-feedback">
                                                            <label for="moon_sign" class="text-uppercase c-gray-light"><?php echo translate('rasi')?></label>
															<?php 
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="nakshatram" class="text-uppercase c-gray-light"><?php echo translate('nakshatram')?></label>
                       <?php 
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="gothram" class="text-uppercase c-gray-light"><?php echo translate('gothram')?></label>
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="age_from" class="text-uppercase c-gray-light"><?php echo translate('age_from')?></label>
                        <input type="text" class="form-control no-resize" name="age_from" value="<?=isset($partner_expectation_data[0]['age_from'])?$partner_expectation_data[0]['age_from']:""?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="partner_age" class="text-uppercase c-gray-light"><?php echo translate('age_to')?></label>
